...
$r^2$ Looks fairly symmetrical just above 0.91, with a slightly longer tail at the lower end.
...
$\log{(\beta_0 * \beta_1)}$ reaches a wide peak just above 2, but is otherwise very symmetrical.
...
We should note that there was a warning calculating the confidence interval for some cities. This may be fine, but it is worth interpreting the results with caution.
