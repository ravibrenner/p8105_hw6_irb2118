...
Here, we will fit a logistic regression model with resolved vs. unresolved as the outcome and victim age, sex, and race as predictors, focusing only on Baltimore, MD.
